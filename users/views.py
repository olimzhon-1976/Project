...
class UserLoginView(LoginView):
    ...
    def form_valid(self, form):
        ...
        if user:
             ...
             if session_key:
                # delete old authorized user card
...
class UserRegistrationView(CreateView):
    ...
    def form_valid(self, form):
        ...
        messages.success(self.request, f"{user.username}, Вы успешно зарегистрировали и вошли в аккаунт ")     
...
#             messages.success(request, f"{user.username}, Вы успешно зарегистрировали и вошли в аккаунт ")     
#             return HttpResponseRedirect(reverse('main:index'))
#     else:
